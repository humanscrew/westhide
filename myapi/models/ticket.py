...
class TicketLaiu8(db.Model):
    ...
    full_ticket_price = db.Column(db.Float, comment="原价")
    discount_price = db.Column(db.Float, comment="票价折扣")
    ...
    real_price = db.Column(db.Float, comment="实际支付价格=实际票价-使用的积分=<微信订单金额>/<支付宝收入金额>")
...
class TicketLaiu8Refund(db.Model):
    ...
    refund_amount = db.Column(db.Float, comment="退款金额")
